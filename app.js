var Home = {
	...
	data: function() {
		return {
			...
			games: [{title: 'Hangman', view: 'hangman'}, {title: 'Tic Tac Toe', view: 'tictactoe'}, {title: 'Checkers', view: 'checkers'}],
			gameSelected: ''
		}
	},
...
var tttBoard = {
	template: `
		<div class="tictactoe__board">
			...
			<p class="text-center tictactoe__go-home"><a href="#" @click.prevent="goHome">Return Home</a></p>
			...
			<div v-show="winner" class="tictactoe__winner">
				<div class="tictactoe__winner-content">
					...
					<button class="btn tictactoe__winner-btn" @click="goHome">Go Back to Home Screen</button>
				</div>
			</div>
		</div>
	`,
